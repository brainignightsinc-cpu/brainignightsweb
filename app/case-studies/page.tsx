...
const caseStudies: CaseStudy[] = [
  ...
  {
    title: 'Tableau to Superset Migration with AI Automation',
    industry: 'Big Data Analytics • Agentic AI',
    challenge: 'Large data analytics firm needed to migrate 50,000+ Tableau dashboards to open-source Superset platform with minimal manual effort.',
    solution: 'Developed agentic AI solution using LangGraph and intelligent tools to automatically analyze, transform, and migrate dashboard configurations with intelligent decision-making.',
    results: [
      '🤖 Automated migration of 50K+ dashboards using agentic AI',
      '⏱️ 90% reduction in manual effort (from 10 months to 1 month)',
      '💰 $4.2M cost savings in migration timeline and team resources',
      '✅ 99.5% migration accuracy with AI-powered validation',
    ],
    icon: '📊',
  },
  {
